...
#     AutoTokenizer,
# )
from transformers import TrainingArguments,AutoTokenizer,AutoModelForCausalLM,DataCollatorForSeq2Seq,Trainer
import torch
...
DATA_NAME = "medical_multi_data_pro.json"
...
def load_model(args, train_dataset, data_collator):
    ...
    swanlab_callback = SwanLabCallback(
        ...
        experiment_name=os.path.join(args.output_dir, args.experiment_name),
